...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    return "</ul>\r\n<button class=\"js-loadMoreBtn\" type=\"button\">Load more</button>";
},"useData":true});
...
var list = __webpack_require__(1435);
...
function _fetchIt() {
  _fetchIt = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(keyword, pageNumber) {
    var url, urlFetch, response, src;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "https://pixabay.com/api/?image_type=photo&orientation=horizontal&q=" + keyword + "&page=" + pageNumber + "&per_page=12&key=17537629-2ee3a1e1cfb1c48a1e1039472";
            _context.next = 4;
            return fetch(url);

          case 4:
            urlFetch = _context.sent;
            _context.next = 7;
            return urlFetch.json();
...
function markupFirstSearch(_x3, _x4) {
  return _markupFirstSearch.apply(this, arguments);
}
...
function createListener() {
  var allGalleryCards = document.querySelector(".js-gallery");
